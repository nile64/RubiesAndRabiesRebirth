package net.mcreator.rubiesandrabies;
...
@Mod("rubies_and_rabies")
public class RubiesAndRabiesMod {
	public static final Logger LOGGER = LogManager.getLogger(RubiesAndRabiesMod.class);
	public static final String MODID = "rubies_and_rabies";

	public RubiesAndRabiesMod(IEventBus modEventBus) {
